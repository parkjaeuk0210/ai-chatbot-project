...
⚠️ LANGUAGE ENFORCEMENT: ${emphasis}`;
    ...
    initializeElements() {
        ...
        this.urlInput = document.getElementById('url-input'); // May not exist in new UI
    ...
    async handleSendMessage() {
        ...
        const apiUrl = window.location.hostname === '127.0.0.1' || window.location.hostname === 'localhost'
            ? '/api/chat-simple'  // Use local API endpoint
            : '/api/chat-simple';  // Use relative path for production
